...
export const products: Product[] = [
  ...
  {
    id: "prod-9",
    name: "Classic Navy Abaya",
    slug: "classic-navy-abaya",
    description:
      "Timeless navy abaya with a relaxed fit and side pockets. Made from breathable crepe fabric, ideal for daily wear and office settings.",
    price: 219,
    sku: "RZ-ABY-009",
    categoryId: "cat-abayas",
    categorySlug: "abayas",
    categoryName: "Abayas",
    brandName: "RukZa Essentials",
    images: [
    ...
    isNew: true,
    isActive: true,
    tags: ["abaya", "navy", "everyday", "modest"],
    rating: 4.7,
    reviewCount: 19,
    variants: [
      { id: "v-9-s", size: "S", stock: 10, sku: "RZ-ABY-009-S" },
      { id: "v-9-m", size: "M", stock: 14, sku: "RZ-ABY-009-M" },
      { id: "v-9-l", size: "L", stock: 11, sku: "RZ-ABY-009-L" },
      { id: "v-9-xl", size: "XL", stock: 7, sku: "RZ-ABY-009-XL" },
    ],
  },
  {
    id: "prod-10",
    name: "Floral Kimono Abaya",
    slug: "floral-kimono-abaya",
    description:
      "Lightweight kimono-style abaya with subtle floral print and open front design. Layer over your favourite outfit for a chic modest look.",
    price: 279,
    salePrice: 229,
    sku: "RZ-ABY-010",
    categoryId: "cat-abayas",
    ...
    isNew: true,
    isActive: true,
    tags: ["abaya", "kimono", "floral", "summer"],
    rating: 4.6,
    reviewCount: 14,
    variants: [
      { id: "v-10-s", size: "S", stock: 8, sku: "RZ-ABY-010-S" },
      { id: "v-10-m", size: "M", stock: 12, sku: "RZ-ABY-010-M" },
      { id: "v-10-l", size: "L", stock: 9, sku: "RZ-ABY-010-L" },
    ],
  },
  {
    id: "prod-11",
    name: "Bisht Style Luxury Abaya",
    slug: "bisht-style-luxury-abaya",
    description:
      "Luxurious bisht-inspired abaya with gold trim and flowing silhouette. Perfect for Eid, weddings, and formal gatherings.",
    price: 549,
    salePrice: 479,
    sku: "RZ-ABY-011",
    categoryId: "cat-abayas",
    ...
    isNew: false,
    isActive: true,
    tags: ["abaya", "luxury", "bisht", "formal"],
    rating: 4.9,
    reviewCount: 31,
    variants: [
      { id: "v-11-s", size: "S", stock: 4, sku: "RZ-ABY-011-S" },
      { id: "v-11-m", size: "M", stock: 5, sku: "RZ-ABY-011-M" },
      { id: "v-11-l", size: "L", stock: 3, sku: "RZ-ABY-011-L" },
    ],
  },
];
...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Amazing website! Easy to browse, fast checkout, and beautiful packaging when my order arrived. Highly recommend RukZa!",
    productName: "RukZa's Fashion Hub",
